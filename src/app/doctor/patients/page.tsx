                ...
                <div className="flex items-center justify-between gap-3 mb-2">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-slate-500">{p.sex} • {p.age} yrs • {p.id}</p>
                    </div>
                  </div>
                  <Badge className={cn("text-[10px] uppercase font-bold shrink-0", p.status === "Active" ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-500")}>{p.status}</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-slate-500 tabular-nums">Last visit: {p.lastVisitISO}</span>
