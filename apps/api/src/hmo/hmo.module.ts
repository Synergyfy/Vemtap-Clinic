...
import { ClaimBatch } from '../entities/claim-batch.entity';
...
@Module({
  imports: [TypeOrmModule.forFeature([HMO, HMOPlan, HMOAgreement, HMOAuthorization, HMOClaim, ClaimBatch, ClaimDocument, HMOAppeal, HMORemittance])],
